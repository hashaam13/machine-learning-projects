...
def test_learn_play(d = 6, num_layers = 2, num_units = 100,
    ...
    scores = []
    def interact(q, iteri=0):
        if iteri % iters_per_value == 0:
            scores.append((iteri, evaluate(game, num_episodes, episode_length,
...
# test_solve_play()
#Tabular Q-learn
#test_learn_play(iters=3000000, tabular=True, batch=False)
# Tabular Batch Q-learn
#test_learn_play(iters=1000, tabular=True, batch=True) # Check: why do we want fewer iterations here?
# NN Q-learn
