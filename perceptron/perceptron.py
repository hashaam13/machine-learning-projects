...
def make_polynomial_feature_fun(order):
    ...
    return f
#a=make_polynomial_feature_fun(50)
#mat=np.zeros((2,1))
#print(a(mat).size)
...
#a=make_polynomial_feature_fun(3)
#train=xor_more()
#print(a)
#new=a(train[0])
#model=perceptron(new,train[1])
#print(model)
...
test_with_features(super_simple_separable_through_origin, 2, draw=True, pause=True)
